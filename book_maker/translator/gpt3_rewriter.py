...
class GPT3Rewriter(Base):
    DEFAULT_PROMPT = "Please help me to rewrite,`{text}` to plain {language} that kids in primary school can understand, please return only translated content not include the origin text"
